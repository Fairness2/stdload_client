<template>
    <div class="page_greed">
        <app-allotment-toolbar dimension="По направлению"></app-allotment-toolbar>
        <div>
            <v-breadcrumbs>
            ...
            <v-flex xs12 sm4>
                ...
                <v-card class="" v-show="isNotSetings">
                    <v-toolbar class="header white--text">
                        <div class="subheading">Направление подготовки</div>
                    </v-toolbar>

                    <v-list two-line class=" highest">
                        <template v-for="item in directions">
                            <v-list-tile
                                    :key="item.id"
                ...
                <v-card class="disciplines" v-show="isGroupSetings">
                    <v-toolbar class="header white--text">
                ...
                <v-card class="groups" v-show="isDirectionSetings">
                    <v-toolbar class="header white--text">
                ...
                <v-card class="jobs" v-show="(isDisciplineSetings || isJobSetings)">
                    <v-toolbar class="header white--text">
            ...
            <v-flex xs12 sm8>
                <v-card class="settings">
                    ...
                    <div class="settings__highest">
                        ...
                        <div v-show="isDirectionSetings">
                            <v-card-title primary-title>
                                <div>
                                    <h3 class="headline mb-0">{{directions[selectedDirection] ? directions[selectedDirection].name : ''}}</h3>
                                    <div><b>Часов всего:</b> {{directions[selectedDirection] ? directions[selectedDirection].all_hours : ''}}</div>
                                    <div v-bind:class="directions[selectedDirection] ? isDistributed(directions[selectedDirection].dis_hours, directions[selectedDirection].all_hours) : ''">
                                        <b>Часов распределено:</b> {{directions[selectedDirection] ? directions[selectedDirection].dis_hours : ''}}
                                    </div>
                                    ...
                                    <div>
                                        <v-select
                                                v-model="selectedEmployeeDirection"
                                                :items="employees"
                                                label="Преподаватель"
                                        ></v-select>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            directions:{
                121: {id: '121', name: 'АСУ', all_hours: 64, dis_hours: 32},
                122: {id: '122', name: 'АСУ1', all_hours: 64, dis_hours: 64},
                123: {id: '123', name: 'АСУ2', all_hours: 64, dis_hours: 72},
                124: {id: '124', name: 'АСУ3', all_hours: 64, dis_hours: 32},
                125: {id: '125', name: 'АСУ4', all_hours: 64, dis_hours: 32},
                126: {id: '126', name: 'РИС', all_hours: 64, dis_hours: 32},
                127: {id: '127', name: 'ЭВТ', all_hours: 64, dis_hours: 32},
            },
            ...
            isNotSetings: true,
            isDirectionSetings: false,
            isDisciplineSetings: false,
            isGroupSetings: false,
            isJobSetings: false,

            selectedEmployeeDirection: null,
        ...
        methods:{
            ...
            selectDirection(id){
                ...
                this.pages.push({
                    text:this.directions[id].name,
                    disabled: true,
                    page: 1
                });

                this.selectedEmployeeDirection = null;
